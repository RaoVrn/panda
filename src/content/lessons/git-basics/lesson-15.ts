    ...
    },
    {
      ...
      quiz: {
        ...
        questions: [
          {
            id: "q1",
            prompt: "What is .gitignore?",
            options: [
              "A list of files Git must never track",
              "A secret password file",
              "Git's settings",
              "A backup",
            ],
            correctIndex: 0,
            explanation: "It's the 'do not look at these' list for your repository.",
          },
          {
            id: "q2",
            prompt: "Which files SHOULD be in .gitignore?",
            options: [
              "Secrets, logs, and rebuildable junk",
              "Your main source code",
              "Your README",
              "Your tests",
            ],
            correctIndex: 0,
            explanation: "Private and junk files — not the actual work you want saved.",
          },
          {
            id: "q3",
            prompt: "What does *.log match?",
            options: [
              "Every file ending in .log",
              "Exactly one file named *.log",
              "Nothing",
              "Only big logs",
            ],
            correctIndex: 0,
            explanation: "The star is a wildcard — it matches any name ending in .log.",
          },
          {
            id: "q4",
            prompt: "If you already committed a secret, does adding it to .gitignore remove it?",
            options: [
              "No — it's still in past snapshots",
              "Yes, instantly",
              "Only after a restart",
              "Git does it automatically",
            ],
            correctIndex: 0,
            explanation: ".gitignore only protects untracked files. Committed secrets stay in history.",
          },
        ],
      },
    },
