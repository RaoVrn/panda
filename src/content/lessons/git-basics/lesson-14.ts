    ...
    },
    {
      ...
      quiz: {
        ...
        questions: [
          {
            id: "q1",
            prompt: "What does git restore <file> do?",
            options: [
              "Rewinds the file to the last snapshot",
              "Deletes the file forever",
              "Uploads the file",
              "Opens the file",
            ],
            correctIndex: 0,
            explanation: "It replaces the working-tree file with the last committed version.",
          },
          {
            id: "q2",
            prompt: "git restore <file> works on…",
            options: [
            ...
            correctIndex: 0,
            explanation: "Restore targets the working tree — changes you haven't staged or committed.",
          },
          {
            id: "q3",
            prompt: "What does git restore --staged <file> do?",
            options: [
              "Unstages the file without deleting changes",
              "Deletes the file",
              "Commits the file",
              "Locks the file",
            ],
            correctIndex: 0,
            explanation: "--staged only moves the file out of the staging area. Your changes are safe.",
          },
          {
            id: "q4",
            prompt: "Can git restore undo a commit?",
            options: [
              "No — commits are permanent history",
              "Yes, always",
              "Only on weekends",
              "Only for big files",
            ],
            correctIndex: 0,
            explanation: "Committed work is history. Restore only touches the working tree.",
          },
        ],
      },
    },
