...
export const lesson14: ContentLesson = {
  ...
  meta: {
    ...
    motivation:
      "You know how to undo mistakes now. One more safety tool left in Git Basics, and then you'll control exactly what Git pays attention to.",
  },
  learningGoals: [
  ...
  blocks: [
    ...
    },
    {
      ...
      id: "tip-git-restore",
      title: "Quick tip",
      text: "Before you restore, check git status. Restore is permanent for unstaged changes. There's no undo for the undo.",
    },
    {
      type: "keyTakeaways",
      id: "takeaways",
