        ...
        questions: [
          {
            ...
            options: [
              "What's happening in your project right now",
              "Your password",
              "The weather",
              "How fast your computer is",
            ],
            correctIndex: 0,
            explanation: "git status reports the state of your working tree and staging area.",
          },
          {
            id: "q2",
            prompt: "\"Changes to be committed\" means the files are…",
            options: [
              "staged and ready for a snapshot",
              "deleted",
              "untracked",
              "on the internet",
            ],
            correctIndex: 0,
            explanation: "That section lists files sitting in the staging area, ready for git commit.",
          },
          {
            id: "q3",
            prompt: "\"Working tree clean\" means…",
            options: [
              "Every change is safely saved",
              "Your computer is dusty",
              "Git is broken",
              "You have too many files",
            ],
            correctIndex: 0,
            explanation: "It's Git's calm way of saying nothing is left unsaved.",
          },
          {
            id: "q4",
            prompt: "Can git status change your files?",
            options: [
              "No — it only looks",
              "Yes — it saves everything",
              "Yes — it deletes files",
              "Only sometimes",
            ],
            correctIndex: 0,
            explanation: "git status is read-only. It never touches your files.",
          },
        ],
      },
    },
