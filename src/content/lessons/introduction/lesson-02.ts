    ...
    },
    {
      ...
      quiz: {
        ...
        questions: [
          {
            id: "q1",
            prompt: "Why do people end up with files like report_FINAL_v2.doc?",
            options: [
              "They're trying to keep versions without a version tool",
              "The computer names files that way",
              "It's a secret coding language",
              "Git makes them do it",
            ],
            correctIndex: 0,
            explanation: "When there's no version control, people fake it by renaming files. That system collapses fast.",
          },
          {
            id: "q2",
            prompt: "Which is a superpower Git gives you?",
            options: [
              "Trying things without being scared of breaking them",
              "Typing faster",
              "A bigger hard drive",
              "Free internet",
            ],
            correctIndex: 0,
            explanation: "Because every snapshot is safe, you can experiment boldly. Mistakes become harmless.",
          },
          {
            id: "q3",
            prompt: "How does Git help a team working on the same file?",
            options: [
              "Everyone has their own copy and Git joins the changes",
              "Only one person can work at a time",
              "It deletes duplicate files",
              "It emails files automatically",
            ],
            correctIndex: 0,
            explanation: "Everyone works on their own copy at the same time; Git carefully merges the results.",
          },
          {
            id: "q4",
            prompt: "Git prevents mistakes. True or false?",
            options: [
              "False — it makes them harmless",
              "True — you can never make a mistake again",
              "True — it blocks bad commands",
              "False — it creates mistakes",
            ],
            correctIndex: 0,
            explanation: "Git doesn't stop you from breaking things. It just makes sure you can always undo it.",
          },
        ],
      },
    },
