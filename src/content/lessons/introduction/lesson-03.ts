...
export const lesson03: ContentLesson = {
  ...
  blocks: [
    ...
    },
    {
      ...
      id: "quiz-1",
      quiz: {
        id: "quiz-installing-git",
        title: "Check what you just learned",
        questions: [
          {
            id: "q1",
            prompt: "What does the terminal let you do?",
            options: [
              "Talk to your computer by typing commands",
              "Only play games",
              "Draw pictures",
              "Charge your battery",
            ],
            correctIndex: 0,
            explanation: "The terminal is a text window: you type a command, press Enter, and the computer answers.",
          },
          {
            id: "q2",
            prompt: "Which command checks whether Git is installed?",
            options: [
              "git --version",
              "git --hello",
              "check git",
            ...
            correctIndex: 0,
            explanation: "`git --version` asks the computer which Git version it has. An answer means it's installed.",
          },
          {
            id: "q3",
            prompt: "Why do you tell Git your name and email?",
            options: [
              "So your snapshots are stamped with who made them",
              "So Git can post online",
              "So Git works faster",
              "It's just for decoration",
            ],
            correctIndex: 0,
            explanation: "Git signs every save with your name and email, so everyone knows who made each change.",
          },
          {
            id: "q4",
            prompt: "How often do you set your Git name and email?",
            options: [
            ...
            correctIndex: 0,
            explanation: "The --global flag stores it for your whole computer, so you set it once and never again.",
          },
        ],
      },
    },
